from disk_free_space_checker import validate_min_space_input


def test_validate_letter_min_space_input_false():
    assert validate_min_space_input('A') is False


def test_validate_empty_min_space_input_false():
    assert validate_min_space_input('') is False
...
def test_validate_malicious_code_min_space_input_false():
    assert validate_min_space_input('eval') is False
